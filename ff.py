...
if __name__ == "__main__":
    ...
    sched.add_job(check_sobh_time, 'interval', seconds=60)
    sched.add_job(check_zohr_time, 'interval', seconds=60)
    sched.add_job(check_asr_time, 'interval', seconds=60)
    sched.add_job(check_magh_time, 'interval', seconds=60)
    sched.add_job(check_isha_time, 'interval', seconds=60)
    sched.start()
    try:
        while True:
            pass
